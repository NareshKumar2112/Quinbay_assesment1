...
public class Orders  {
    ...
    private List<String> product_suppilers;
    ...
    public List<String> getProduct_suppilers() {
        return product_suppilers;
    }

    public void setProduct_suppilers(List<String> product_suppilers) {
        this.product_suppilers = product_suppilers;
    }
}
